...
<div>
    <h4 id="head" style="margin: 20px;">${decodeURIComponent(showFullPath ? filePath : pathSplit[pathSplit.length - 1])}</h4>
</div>
...
<div id="${containerId}" class="emgithub-container">
  ...
  <div class="emgithub-file emgithub-file-${isDarkStyle ? 'dark' : 'light'}"
    ...
    ${showFileMeta ? `<div class="file-meta file-meta-${isDarkStyle ? 'dark' : 'light'}"
      ...
      delivered <span class="hide-in-phone">with ❤ From J.A.R.V.I.Z</span>
    </div>`: ''
    }
  </div>
  <div class="row">
